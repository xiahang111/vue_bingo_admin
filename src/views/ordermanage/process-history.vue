<template>
  <div class="app-container">
    ...
    <el-table v-loading="listLoading" :data="list" element-loading-text="Loading..." border fit highlight-current-row>
      ...
      <el-table-column align="center" sortable label="文件名" prop="fileName" >
      ...
      <el-table-column align="center" sortable label="状态" prop="status" width="160">
        ...
        <template slot-scope="scope">
          ...
          <span v-if="scope.row.status == '3'">
            <el-tag type="success" >正在处理</el-tag>
          </span>
        </template>
...
<script>
  ...
  import { getProcessHistoryPage } from '@/api/order.js'
  ...
  export default {
    ...
    methods: {
      getList() {
        ...
        getProcessHistoryPage(params).then(response => {
