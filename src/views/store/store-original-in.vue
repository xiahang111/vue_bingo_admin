<template>
  <div class="app-container">
    ...
    <el-table v-loading="listLoading" :data="list" element-loading-text="Loading..." border fit highlight-current-row>
      ...
      <el-table-column align="center" label="来源" prop="originalResource">

        <template slot-scope="scope">
          <span v-if="scope.row.originalResource == 'STORE_IN_XX'">铣型料入库</span>
          <span v-if="scope.row.originalResource == 'STORE_IN_RY'">荣一料入库</span>
          <span v-if="scope.row.originalResource == 'STORE_IN_SD'">山东料入库</span>
        </template>
      ...
      <el-table-column align="center" sortable label="铝锭价格" prop="aluPrice">
      ...
      <!-- 创建时间-->
      <el-table-column align="center" label="订单日期" width="220">
        <template slot-scope="scope">
    ...
    <el-dialog title="" :visible.sync="dialogFormVisible">
      ...
      <el-form ref="form" :model="storeRecord" label-width="120px" :rules="rules">
        ...
        <el-form-item label="理论支重:">
          <el-input v-model="storeRecord.weight" placeholder="请输入" style="width: 60%"/>
        </el-form-item>

        <el-form-item label="重量:">
          <el-input v-model="storeRecord.totalWeight" placeholder="请输入" style="width: 60%"/>
        </el-form-item>

        <el-form-item label="单位:">
          <el-select v-model="storeRecord.unit" placeholder="请选择" style="width: 60%">
            <el-option
              v-for="item in unit"
              :key="item.value"
              :label="item.label"
        ...
        <el-form-item label="单价:">
          <el-input v-model="storeRecord.price" placeholder="请输入" style="width: 60%"/>
        </el-form-item>

        <el-form-item label="铝锭价格:">
          <el-input v-model="storeRecord.aluPrice" placeholder="请输入" style="width: 60%"/>
        </el-form-item>

        <el-form-item label="金额:">
          <el-input v-model="storeRecord.totalPrice" placeholder="请输入" style="width: 60%"/>
        </el-form-item>
  ...
  export default {
    ...
    data() {
      return {
        ...
        originalSource: [{value: '1', label: '铣型料入库'},
          {value: '2', label: '荣一料入库'},
          {value: '3', label: '山东料入库'}],
