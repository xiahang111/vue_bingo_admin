        ...
        <el-form style="margin-left: 20px;" label-position="left" :model="form" label-width="100px" ref="changeAdminForm">
          ...
          <el-form-item label="昵称">
            ...
            <el-form-item label="性别">
              <el-radio v-for="gender in genderList" :key="gender.value" v-model="form.gender" :label="gender.label" border size="medium">{{gender.label}}</el-radio>
            </el-form-item>

          &lt;!&ndash; <el-form-item label="手机号">
          ...
          <el-form-item>
            ...
            &lt;!&ndash; <el-button @click="cancel('changeAdminForm')">重 置</el-button>             &ndash;&gt;
          </el-form-item>
...
export default {
  data() {
    return {
      genderList: [{value: '1', label: '男'},{value: '2', label: '女'}], //字典列表
      activeName: "one",
