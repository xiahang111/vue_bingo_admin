<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input v-model="listQuery.keyword" placeholder="产品名称" style="width: 200px;" class="filter-item" @keyup.enter.native="handleFilter" />
...
import { getGlassRecordByQuery } from '../../../api/product.js'
...
export default {
  ...
  methods: {
    getList() {
      ...
      getGlassRecordByQuery(params).then(response => {
