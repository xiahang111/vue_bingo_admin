<template>
  <div class="app-container">
    <el-form ref="form" :model="product" label-width="120px" :rules="rules">
      ...
      <el-form-item label="产品名称" prop="productUid">
        <el-col :span="6">
          <el-select v-model="product.productUid" placeholder="请选择" >
      ...
      <el-form-item label="是否带灯">

        <el-radio v-model="product.isLight" label="true">带灯</el-radio>
        <el-radio v-model="product.isLight" label="false">不带灯</el-radio>
      </el-form-item>

      <el-form-item label="是否带拉手">

        <el-radio v-model="product.isHandle" label="true">带拉手</el-radio>
        <el-radio v-model="product.isHandle" label="false">不带拉手</el-radio>
      </el-form-item>

      <el-form-item label="拼接方式">

        <el-radio v-model="product.corner" label="1">直角拼接</el-radio>
        <el-radio v-model="product.corner" label="2">45度角拼接</el-radio>
      </el-form-item>
      <!-- 日期选择 -->
    ...
    <el-table :data="productResultList" style="width: 100%" align="center">
      ...
      <el-table-column prop="corner" label="拼接类型" width="180"></el-table-column>
      <el-table-column prop="handle" label="是否带拉手" width="180"></el-table-column>
      <el-table-column prop="light" label="是否带灯" width="180"></el-table-column>
      <el-table-column prop="resultDetail" label="下料详情" ></el-table-column>
...
<script>
  ...
  import { getAllProduct, materialCalculate } from '../../../api/product.js'
      ...
      onSubmit(formName) {
        ...
        this.$refs[formName].validate((valid) => {
          ...
          if (valid) {
            ...
            materialCalculate(this.product).then(response => {
